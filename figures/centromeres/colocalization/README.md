...
```
python plot_primer_repeat_distances.py --primers bTaeGut7v0.4_MT_rDNA.BLAST.Knief2016.v0.1.bed --gff bTaeGut7v0.4_MT_rDNA.RM.Takki2022.v0.1.colored.merged.gff --out plot.png --macrochrs macros.ls --label-chrom --largest-repeat-only
```
