...
2. gap2 and gap3 were modelled using [TTT](https://github.com/marbl/TTT) and the patch sequences were manually aligned using lastal (v1648) and the additional sequence was introduced using gfastats
