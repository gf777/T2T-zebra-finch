...
RESOLUTIONS=(200000)        # list of resolutions to process
DATE="20250313"          # date string in filenames
METHOD="bwa"              # aligner suffix in prefixes
BASE_PREFIX="bTaeGut7"    # common prefix
COLL_PREFIX="bTaeGut7v0.4_MT_rDNA.Cooltools.v0.2.E1.200Kb.flipped.dip.collated"
...
# # 4) Convert collated bedGraph into A/B compartments BED track
# AB_BED="${COLL_PREFIX}.AB.bed"
# echo "Generating A/B compartments BED: $AB_BED"
# awk 'BEGIN{OFS="\t"} { if ($4 > 0) print $1, $2, $3, "A"; else if ($4 < 0) print $1, $2, $3, "B" }' "$COLL_BG" > "$AB_BED"
